...
def should_upload_file(relative_path, full_path):
    ...
    benign_files = {
        ...
        '/var/cache/yum/x86_64/2/timedhosts',
        ...
        '/var/lib/dhclient/dhclient6--eth0.lease',
        '/var/lib/dhcpcd/duid',
        '/var/lib/dhcpcd/ens5.lease',
        ...
        '/var/lib/NetworkManager/internal-e5dc68fb-3d7e-5a8e-aca6-e415d1b8c85d-ens5.lease',
        ...
        '/var/log/amazon/ssm/amazon-ssm-agent-audit-2025-06-15',
        ...
        '/var/log/dpkg.log',
        '/var/log/hawkey.log',
        '/var/log/journal/f2c688471a8f4797b0b2504100d3d0da/system.journal',
        '/var/log/journal/f2c688471a8f4797b0b2504100d3d0da/system@11bd472cfc234981b348e8f04062d1d9-0000000000000001-0005f561c0cb2eda.journal',
        '/var/log/kern.log',
        '/var/log/lastlog',
        '/var/log/maillog',
        '/var/log/messages',
